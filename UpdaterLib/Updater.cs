...
namespace Updater
{
    ...
    {
        public string Endpoint = "https://ip.ripple.moe/updater.json";
        ...
        public Updater()
        {
            try
            {
                AssemblyVersion = Convert.ToInt32(FileVersionInfo.GetVersionInfo("RippleServerSwitcher.exe").FileVersion.Replace(".", string.Empty));
            }
            catch
            {
                AssemblyVersion = 0;
